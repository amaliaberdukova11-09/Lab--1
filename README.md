# Тема: Указатели
## Задача 1 - упражнение с malloc и сложными однострочными выражениями с C с присваиваниями внутри
...
При этом выполните следующие: - Используйте функции типа *alloc(...) для выделения оперативной памяти под
...
https://github.com/amaliaberdukova11-09/Lab--1/blob/ea54c915679f7ed1b360e0020de748171a5b53fb/2026-01-08_18-53-16.png
---
